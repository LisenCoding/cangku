    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpinOrder !=null){
            ...
            //级联表 车辆
            //级联表
            CheliangEntity cheliang = cheliangService.selectById(shangpinOrder.getCheliangId());
            if(cheliang != null){
            BeanUtils.copyProperties( cheliang , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            view.setCheliangId(cheliang.getId());
            }
            //级联表 司机
            //级联表
            SijiEntity siji = sijiService.selectById(shangpinOrder.getSijiId());
            if(siji != null){
            BeanUtils.copyProperties( siji , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
...
//                            shangpinOrderEntity.setCheliangId(Integer.valueOf(data.get(0)));   //车辆 要改的
//                            shangpinOrderEntity.setSijiId(Integer.valueOf(data.get(0)));   //司机 要改的
...
//                            shangpinOrderEntity.setCreateTime(date);//时间
        ...
        ShangpinOrderEntity shangpinOrder = shangpinOrderService.selectById(id);
            if(shangpinOrder !=null){
                ...
                //级联表
                    CheliangEntity cheliang = cheliangService.selectById(shangpinOrder.getCheliangId());
                if(cheliang != null){
                    BeanUtils.copyProperties( cheliang , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setCheliangId(cheliang.getId());
                }
                //级联表
                    SijiEntity siji = sijiService.selectById(shangpinOrder.getSijiId());
                if(siji != null){
                    BeanUtils.copyProperties( siji , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setSijiId(siji.getId());
                }
                //级联表
                    YonghuEntity yonghu = yonghuService.selectById(shangpinOrder.getYonghuId());
    ...
    */
    ...
    public R deliver(Integer id  , HttpServletRequest request){
        ...
        HuowuEntity<Object> objectHuowuEntity = new HuowuEntity<>();
        ...
        objectHuowuEntity.setShangpinOrderId(id);
        objectHuowuEntity.setHuowuTypes(1);
        objectHuowuEntity.setHuowuName(shangpinEntity.getShangpinName());
        objectHuowuEntity.setHuowuUuidNumber(String.valueOf(new Date().getTime()));
        objectHuowuEntity.setInsertTime(new Date());
        objectHuowuEntity.setCreateTime(new Date());
        objectHuowuEntity.setHuowuDelete(1);
        huowuService.insert(objectHuowuEntity);
        shangpinOrderEntity.setShangpinOrderTypes(103);//设置订单状态为已发出
    ...
    public R receiving(Integer id , HttpServletRequest request){
        ...
        ShangpinEntity shangpinEntity = shangpinService.selectById(shangpinOrderEntity.getShangpinId());
        objectHuowuEntity.setShangpinOrderId(id);
        objectHuowuEntity.setHuowuTypes(3);
        objectHuowuEntity.setHuowuName(shangpinEntity.getShangpinName());
        objectHuowuEntity.setHuowuUuidNumber(String.valueOf(new Date().getTime()));
        objectHuowuEntity.setInsertTime(new Date());
        objectHuowuEntity.setCreateTime(new Date());
        objectHuowuEntity.setHuowuDelete(1);
        huowuService.insert(objectHuowuEntity);
        shangpinOrderEntity.setShangpinOrderTypes(104);//设置订单状态为验收
        shangpinOrderService.updateById( shangpinOrderEntity);
        return R.ok();
    }
    ...
    public R songda(Integer id , HttpServletRequest request){
        logger.debug("refund:,,Controller:{},,ids:{}",this.getClass().getName(),id.toString());
        ShangpinOrderEntity  shangpinOrderEntity = shangpinOrderService.selectById(id);
        HuowuEntity<Object> objectHuowuEntity = new HuowuEntity<>();
        ShangpinEntity shangpinEntity = shangpinService.selectById(shangpinOrderEntity.getShangpinId());
        objectHuowuEntity.setShangpinOrderId(id);
        objectHuowuEntity.setHuowuTypes(2);
        objectHuowuEntity.setHuowuName(shangpinEntity.getShangpinName());
        objectHuowuEntity.setHuowuUuidNumber(String.valueOf(new Date().getTime()));
        objectHuowuEntity.setInsertTime(new Date());
        objectHuowuEntity.setCreateTime(new Date());
        objectHuowuEntity.setHuowuDelete(1);
        huowuService.insert(objectHuowuEntity);
        shangpinOrderEntity.setShangpinOrderTypes(106);//设置订单状态为验收
        shangpinOrderService.updateById( shangpinOrderEntity);
        return R.ok();
    }
