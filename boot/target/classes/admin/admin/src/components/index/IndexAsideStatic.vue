      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          ...
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "linear-gradient(135deg, dodgerblue 0%, dodgerblue 70%, var(--publicSubColor) 70%, var(--publicSubColor) 100%)"
...
<style lang="scss" scoped>
  ...
  .index-aside {
    ...
    .menulist-item {
      ...
      background: linear-gradient(135deg, dodgerblue 0%, dodgerblue 78%, var(--publicSubColor) 78%, var(--publicSubColor) 100%) !important;
