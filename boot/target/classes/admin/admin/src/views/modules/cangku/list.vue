        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wuliuguanlixitong/upload/cangkuMuBan.xls"
                        >批量导入仓库数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('cangku','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="cangkuUuidNumber"
                                   header-align="center"
                                   label="仓库编号">
                        <template slot-scope="scope">
                            {{scope.row.cangkuUuidNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="cangkuPhoto"
                                     header-align="center"
                                     width="200"
                                     label="仓库照片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.cangkuPhoto">
                                <img :src="$base.url+scope.row.cangkuPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
